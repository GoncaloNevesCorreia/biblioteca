...
<tbody>
    ...
    <?php
        ...
        $rows = [];
        $sql = "SELECT ID, ISBN, num, titulo, genero, autor, editora, edicao, estado FROM livros where requisitavel = 1 ORDER BY ISBN ASC, num ASC LIMIT $offset, $total_records_per_page";
...
<div>
    <div id="book-details">
        <form action="process.php" method="POST">
            ...
            <div id="num-wrapper">
                    <label for="num">Titulo:</label><br>
                    <input type="number" id="titulo" name="num"><br>
                </div>

                <div id="num-wrapper" >
                    <label for="num">Nome:</label><br>
                    <input type="number" id="requisitante" name="num"><br>
                </div>
            ...
            <button id="btnPost" name="add" type="submit">Requisitar</button>
